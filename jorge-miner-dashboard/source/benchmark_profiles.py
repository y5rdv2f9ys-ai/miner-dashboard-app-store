...
PROFILE_ORDER = (
    "nerdos_nerdoctaxe",
    "nerdos_nerdqaxe",
    "axeos_bitaxe403_bm1368",
    "axeos_bitaxe",
)

PROFILES = {
    "axeos_bitaxe403_bm1368": {
        "id": "axeos_bitaxe403_bm1368",
        "label": "AxeOS / Bitaxe 403 (BM1368)",
        "miner_type": "axeos",
        "match_terms": ("bitaxe403", "bitaxe 403", "bm1368"),
        "frequency": {"min": 525, "max": 650, "step": 25},
        "voltage": {"min": 1050, "max": 1200, "step": 5},
        "safe_reference": {"frequency": 500, "voltage": 1150},
        "timing": {
            "warmup_seconds": 180,
            "test_seconds": 600,
    ...
    "nerdos_nerdqaxe": {
        ...
        "safety": {
            ...
            "max_vr_temp": 90,
            "max_power_watts": 90,
            "min_input_voltage": 11.6,
            "max_input_voltage": 12.5,
            "max_reject_pct": 2.0,
            "max_error_percentage": 5.0,
            "instability_sample_limit": 3,
            "api_failure_limit": 3,
